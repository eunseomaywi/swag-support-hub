...
export type Database = {
  public: {
    ...
    Enums: {
      ...
      peer_request_status:
        "open" | "accepted" | "scheduled" | "completed" | "cancelled" | "escalated";
      peer_session_status: "confirmed" | "completed" | "cancelled";
...
export const Constants = {
  public: {
    Enums: {
      app_role: ["student", "peer_mentor", "swag_member", "teacher"],
      peer_request_status: ["open", "accepted", "scheduled", "completed", "cancelled", "escalated"],
      peer_session_status: ["confirmed", "completed", "cancelled"],
      peer_slot_status: ["available", "reserved", "withdrawn"],
    },
  },
